...
public class ManufacturerOrderListAdapter extends BaseAdapter {
    ...
    public ManufacturerOrderListAdapter(Context context, ArrayList<OrderData> orderDataArrayList)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, SingleOrderDetailsManufacturer.class);
