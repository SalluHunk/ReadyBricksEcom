...
public class PastOrderFragment extends Fragment implements OrderListView {
    ...
    public void onResume() {
        progressDialog.show();
        orderListPresenter.listOrder(sharedPreferences.getString(AlaBricks.sharedUserId,""),"4");
        super.onResume();
    }
