...
public class ManuPastOrderFragment extends Fragment implements ManuOrderListView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        orderListPresenter.orderListManufacturer(sharedPreferences.getString(AlaBricks.sharedUserId,""),"4");
